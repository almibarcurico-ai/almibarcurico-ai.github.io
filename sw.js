...
self.addEventListener('install',function(e){
  e.waitUntil(
    caches.open(PAGES).then(function(c){
      return c.addAll(['/','/carta.html','/fonda.html','/happy-hour.html','/promociones.html','/tenedor-libre.html','/secciones.css','/delivery.html','/reservas.html','/reservas.js','/socio.html','/privacidad.html','/acceso.css','/acceso.js']).catch(function(){});
